...
if (runnerAge > 18 && earlyRegister) {
  raceNumber += 1000;
  console.log(`You are number ${raceNumber} and will race at 9:30am`);
} else if (runnerAge > 18 && earlyRegister === false) {
  console.log(`You are number ${raceNumber} and will race at 11:00am`);
} else if(runnerAge < 18) {
  console.log(`You are number ${raceNumber} and will race at 12:00pm`);
} else {
