...
let userName = "danvgar";

userName ? console.log(`Hello, ${userName}`) : console.log(`Hello!`);

let userQuestion = `Will I get a Software Engineering job in 2023?`;

userName
    ? console.log(`${userName} asked: ${userQuestion}`) : console.log(`You asked: ${userQuestion}`);
