...
const reverseString = (string) => console.log(string.split("").reverse().join(""))
...
const palindromeCheck = function (string) {
    ...
    return string === reverseString(string) ? alert(`It is a palindrome!`) : alert(`It is not a palindrome!`)
}
